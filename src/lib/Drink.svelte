      ...
      <div class="form-control">
        ...
        <div class="flex space-y-2">
          <label class="cursor-pointer">
            <input type="radio" name="size" class="radio radio-bordered" value="Stor" />
            <span class="ml-2">Stor</span>
          </label>
          <label class="cursor-pointer">
            <input type="radio" name="size" class="radio radio-bordered" value="Liten" />
            <span class="ml-2">Liten</span>
          </label>
          <label class="cursor-pointer">
            <input 
            type="radio" name="size" class="radio radio-bordered"
            value="Egen kopp"
