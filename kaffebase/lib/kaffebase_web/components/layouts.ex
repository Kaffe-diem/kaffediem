    ...
    <header class="navbar px-4 sm:px-6 lg:px-8">
      <div class="flex-1">
        <a href="/" class="flex-1 flex w-fit items-center gap-2">
          ...
          <span class="text-sm font-semibold">v{Application.spec(:kaffebase, :vsn)}</span>
        </a>
      </div>
      <div class="flex-none">
  ...
  def flash_group(assigns) do
    ...
    <div id={@id} aria-live="polite">
      ...
      <.flash
        id="client-error"
        kind={:error}
        title={gettext("We can't find the Kaffebase")}
      ...
      <.flash
        id="server-error"
        kind={:error}
        title={gettext("Something went wrong! Kaffebase")}
